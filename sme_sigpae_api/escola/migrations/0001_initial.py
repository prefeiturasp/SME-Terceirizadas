    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "iniciais",
                    models.CharField(
                        blank=True, max_length=10, verbose_name="Iniciais"
                    ),
                ),
                (
                    "nome",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nome",
                    models.CharField(blank=True, max_length=160, verbose_name="Nome"),
                ),
                (
                    "codigo_eol",
                    models.CharField(
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=1, verbose_name="Quantidade de alunos"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipos_alimentacao",
                    models.ManyToManyField(
                        related_name="periodos_escolares", to="cardapio.TipoAlimentacao"
                    ),
                ),
            ],
            options={
