        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (36, "Papa enviou solicitação de remessa"),
                    (37, "DILOG enviou solicitação de remessa"),
                    (38, "Distribuidor confirmou solicitação de remessa"),
                    (39, "Distribuidor pede alteração da solicitação de remessa"),
                    (40, "Papa cancelou solicitação de remessa"),
                ]
            ),
        ),
    ]
