        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (37, "CODAE recusou reclamação"),
                    (38, "CODAE questionou terceirizada sobre reclamação"),
                    (33, "CODAE questionou U.E. sobre reclamação"),
                    (39, "CODAE respondeu ao reclamante da reclamação"),
                    (36, "CODAE questionou nutrisupervisor sobre reclamação"),
                    (31, "Terceirizada respondeu a reclamação"),
                    (34, "U.E. respondeu a reclamação"),
                    (35, "Nutrisupervisor respondeu a reclamação"),
                    (32, "Terceirizada respondeu a análise"),
                    (41, "Papa enviou a requisição"),
                    (42, "Dilog Enviou a requisição"),
                    (43, "Distribuidor confirmou requisição"),
                    (44, "Distribuidor pede alteração da requisição"),
                    (45, "Papa cancelou a requisição"),
                    (46, "Papa aguarda confirmação do cancelamento da solicitação"),
                    (47, "Dilog Aceita Alteração"),
                    (48, "Dilog Nega Alteração"),
                    (49, "Cancelamento por alteração de unidade educacional"),
                    (50, "Cancelamento para aluno não matriculado na rede municipal"),
                ]
            ),
        ),
    ]
