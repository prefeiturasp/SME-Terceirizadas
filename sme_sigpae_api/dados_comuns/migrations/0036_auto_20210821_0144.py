        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (46, "Dilog Aceita Alteração"),
                    (47, "Dilog Nega Alteração"),
                    (48, "Cancelamento por alteração de unidade educacional"),
                    (49, "Cancelamento para aluno não matriculado na rede municipal"),
                ]
            ),
        ),
    ]
