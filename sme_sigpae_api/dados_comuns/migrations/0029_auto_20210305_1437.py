        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (41, "Dilog Aceita Alteração"),
                    (42, "Dilog Nega Alteração"),
                    (43, "Cancelamento por alteração de unidade educacional"),
                    (44, "Cancelamento para aluno não matriculado na rede municipal"),
                ]
            ),
        ),
    ]
