                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[
                            ...
                            (5, "Inclusão de alimentação contínua"),
                            (6, "Dieta Especial"),
                            (7, "Solicitação de kit lanche unificada"),
                        ]
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "assunto",
                    models.CharField(
                        blank=True, max_length=256, verbose_name="Assunto"
                    ),
                ),
                (
                    "template_html",
                    models.TextField(blank=True, verbose_name="Template"),
                ),
            ],
            options={
