        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (72, "Alteração cronograma aprovada pela DINUTRE"),
                    (73, "Alteração cronograma reprovada pela DINUTRE"),
                    (74, "Alteração cronograma aprovada pela DILOG"),
                    (75, "Alteração cronograma reprovada pela DILOG"),
                    (76, "CODAE cancelou solicitação de correção"),
                    (77, "Terceirizada cancelou solicitação de correção"),
                ]
            ),
        ),
    ]
