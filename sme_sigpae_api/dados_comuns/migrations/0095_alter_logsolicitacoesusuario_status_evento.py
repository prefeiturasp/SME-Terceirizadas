...
class Migration(migrations.Migration):
    dependencies = [
        ("dados_comuns", "0094_alter_logsolicitacoesusuario_status_evento"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (72, "Aprovado DINUTRE"),
                    (73, "Reprovado DINUTRE"),
                    (74, "Aprovado DILOG"),
                    (75, "Reprovado DILOG"),
                    (76, "CODAE cancelou solicitação de correção"),
                    (77, "Terceirizada cancelou solicitação de correção"),
                    (78, "Em Análise"),
                    (79, "Notificação criada"),
                    (80, "Notificação enviada para o fiscal"),
                    (81, "Correção solicitada pela CODAE"),
                    (82, "Corrigido para CODAE"),
                    (85, "Alteração CODAE"),
                    (86, "Alteração enviada ao fornecedor"),
                ]
            ),
        ),
    ]
