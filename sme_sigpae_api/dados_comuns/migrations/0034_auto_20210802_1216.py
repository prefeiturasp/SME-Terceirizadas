        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (35, "CODAE recusou reclamação"),
                    (36, "CODAE questionou terceirizada sobre reclamação"),
                    (33, "CODAE questionou U.E. sobre reclamação"),
                    (37, "CODAE respondeu ao reclamante da reclamação"),
                    (31, "Terceirizada respondeu a reclamação"),
                    (34, "U.E. respondeu a reclamação"),
                    (32, "Terceirizada respondeu a análise"),
                    (39, "Papa enviou a requisição"),
                    (40, "Dilog Enviou a requisição"),
                    (41, "Distribuidor confirmou requisição"),
                    (42, "Distribuidor pede alteração da requisição"),
                    (43, "Papa cancelou a requisição"),
                    (44, "Dilog Aceita Alteração"),
                    (45, "Dilog Nega Alteração"),
                    (46, "Cancelamento por alteração de unidade educacional"),
                    (47, "Cancelamento para aluno não matriculado na rede municipal"),
                ]
            ),
        ),
    ]
