        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (36, "CODAE recusou reclamação"),
                    (37, "CODAE questionou terceirizada sobre reclamação"),
                    (33, "CODAE questionou U.E. sobre reclamação"),
                    (38, "CODAE respondeu ao reclamante da reclamação"),
                    (35, "CODAE questionou nutrisupervisor sobre reclamação"),
                    (31, "Terceirizada respondeu a reclamação"),
                    (34, "U.E. respondeu a reclamação"),
                    (32, "Terceirizada respondeu a análise"),
                    (40, "Papa enviou a requisição"),
                    (41, "Dilog Enviou a requisição"),
                    (42, "Distribuidor confirmou requisição"),
                    (43, "Distribuidor pede alteração da requisição"),
                    (44, "Papa cancelou a requisição"),
                    (45, "Dilog Aceita Alteração"),
                    (46, "Dilog Nega Alteração"),
                    (47, "Cancelamento por alteração de unidade educacional"),
                    (48, "Cancelamento para aluno não matriculado na rede municipal"),
                ]
            ),
        ),
    ]
