...
def migracao_dados(apps, _):
    InclusaoAlimentacaoDaCEI = apps.get_model(
        "inclusao_alimentacao", "InclusaoAlimentacaoDaCEI"
    )
    DiasMotivosInclusaoDeAlimentacaoCEI = apps.get_model(
        "inclusao_alimentacao", "DiasMotivosInclusaoDeAlimentacaoCEI"
    )
