    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hora_tentativa",
                    models.TimeField(verbose_name="Hora da tentativa de entrega"),
                ),
                (
                    "nome_motorista",
                    models.CharField(max_length=100, verbose_name="Nome do motorista"),
                ),
                (
                    "placa_veiculo",
                    models.CharField(max_length=7, verbose_name="Placa do veículo"),
                ),
                (
                    "justificativa",
                    models.TextField(max_length=500, verbose_name="Justificativa"),
                ),
