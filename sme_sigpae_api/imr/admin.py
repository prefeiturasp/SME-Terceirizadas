...
from sme_sigpae_api.dados_comuns.utils import custom_titled_filter
from sme_sigpae_api.imr.api.services import (
...
class ParametrizacaoOcorrenciaAdmin(admin.ModelAdmin):
    list_display = (
        "tipo_ocorrencia",
        "edital",
        "posicao",
