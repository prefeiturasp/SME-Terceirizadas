# Generated by Django 2.2.13 on 2022-09-14 19:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solicitacao_kit_lanche_cemei', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='solicitacao_emei', to='kit_lanche.SolicitacaoKitLancheCEMEI')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alunos_com_dieta_especial_participantes', models.ManyToManyField(to='escola.Aluno')),
                ('kits', models.ManyToManyField(blank=True, to='kit_lanche.KitLanche')),
                ('solicitacao_kit_lanche_cemei', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='solicitacao_cei', to='kit_lanche.SolicitacaoKitLancheCEMEI')),
            ],
            options={
                'verbose_name': 'Solicitação Kit Lanche CEI da EMEI',
                'verbose_name_plural': 'Solicitações Kit Lanche CEI da EMEI',
