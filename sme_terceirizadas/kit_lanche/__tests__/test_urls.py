...
def test_url_endpoint_solicitacoes_kit_lanche_avulsa_inicio_fluxo(client_autenticado_da_escola, solicitacao_avulsa, periodo_escolar):
...
def test_url_endpoint_solicitacoes_kit_lanche_avulsa_inicio_fluxo_exception(client_autenticado_da_escola,
    ...
    mommy.make('escola.AlunosMatriculadosPeriodoEscola', escola=solicitacao_avulsa_dre_a_validar.escola, quantidade_alunos=800,
                periodo_escolar=periodo_escolar)
    response = client_autenticado_da_escola.patch(
...
def test_create_kit_lanche(client_autenticado_da_escola, solicitacao_avulsa, escola, kit_lanche, aluno, periodo_escolar):
    ...
    """
    escola.save()
    mommy.make('escola.AlunosMatriculadosPeriodoEscola', escola=escola, quantidade_alunos=400,
                periodo_escolar=periodo_escolar)
