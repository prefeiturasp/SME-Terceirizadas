...
class RequisicoesExcelService(object):
    ...
    def exportar_visao_distribuidor(cls, requisicoes, is_async=False):
        ...
        cabecalho = ['Nº da Requisição',
                     ...
                     'Nome da UE',
                     'Código EOL da UE',
                     'Endereço da UE (com o número - concatenar)',
                     'Bairro da UE',
                     'Cep da UE',
                     'Telefone UE',
                     'Número da Guia',
                     'Quantidade (com tipo de embalagem - concatenar)',
                     'Capacidade (Embalagem Fechada) - com unidade de medida - concatenar (sem o tipo de embalagem)',
                     'Quantidade (Fracionada) - com tipo de embalagem - concatenar',
                     'Capacidade (Embalagem Fracionada) - com unidade de medida - concatenar (sem o tipo de embalagem)',
                     'Código Supri',
                     'Agrupamento']
