...
def test_url_authorized_vincula_guias(client_autenticado_codae_dilog, guia):
    response = client_autenticado_codae_dilog.patch('/guias-da-requisicao/inconsistencias/')
    assert response.status_code == status.HTTP_200_OK
