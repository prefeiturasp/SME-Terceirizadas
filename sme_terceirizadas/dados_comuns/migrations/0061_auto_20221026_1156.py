    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', django_xworkflows.models.StateField(max_length=21, workflow=django_xworkflows.models._SerializedWorkflow(initial_state='RASCUNHO', name='CronogramaWorkflow', states=['RASCUNHO', 'ENVIADO_AO_FORNECEDOR']))),
            ],
            options={
                'abstract': False,
            },
