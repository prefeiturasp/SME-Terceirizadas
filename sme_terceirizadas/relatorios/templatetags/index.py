...
@register.filter
def formatar_observacoes(observacoes, cei=None):
    ...
    for dia in dias:
        ...
        if cei:
            obs_ordenadas_periodo_grupo = sorted(obs_filtradas_por_dia, key=lambda k: constants.ORDEM_PERIODOS_GRUPOS_CEI[k[4]])
        else:
