...
router.register('escola-quantidade-alunos-por-faixa-etaria', viewsets.EscolaQuantidadeAlunosPorFaixaViewSet,
                basename='escola-quantidade-alunos-por-faixa-etaria')
