...
from sme_terceirizadas.pre_recebimento.models import DocumentoDeRecebimento
...
def test_patch_analise_documentos_aprovar(
    ...
    response = client.patch(f"/documentos-de-recebimento/{documento_de_recebimento.uuid}/analise-documentos/",
