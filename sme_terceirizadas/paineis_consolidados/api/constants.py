...
CEU_GESTAO_PERIODOS_COM_SOLICITACOES_AUTORIZADAS = 'ceu-gestao-periodos-com-solicitacoes-autorizadas'
...
STATUS_SOLICITACAO = '(?P<status_solicitacao>(AUTORIZADOS|NEGADOS|CANCELADOS|RECEBIDAS|TODOS)+)'
