...
class DiretorRegional(Describable):
...
class PeriodoEscolar(Describable):
    """Períodos Escolares"""
...
class Escola(Activable):
    ...
    grouping = models.ForeignKey(SchoolGroup,
                                 ...
                                 blank=True,
                                 null=True)
    regional_director = models.ForeignKey(DiretorRegional,
                                          on_delete=models.DO_NOTHING,
                                          blank=True,
                                          null=True)
    ...
    periods = models.ManyToManyField(PeriodoEscolar, blank=True)
