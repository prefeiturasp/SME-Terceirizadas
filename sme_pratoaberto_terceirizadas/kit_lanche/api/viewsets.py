...
from sme_pratoaberto_terceirizadas.kit_lanche.api.serializers import (
    MotivoSolicitacaoUnificadaSerializer, KitLancheSerializer,
...
from sme_pratoaberto_terceirizadas.kit_lanche.models import (
    MotivoSolicitacaoUnificada, KitLanche,
...
class MotivoSolicitacaoUnificadaViewSet(ModelViewSet):
    ...
    serializer_class = MotivoSolicitacaoUnificadaSerializer
...
# class SolicitacaoKitLancheViewSet(ReadOnlyModelViewSet):
#     lookup_field = 'uuid'
#     queryset = SolicitacaoKitLanche.objects.all()
#     serializer_class = SolicitacaoKitLancheSimplesSerializer


class SolicitacaoKitLancheAvulsaViewSet(ModelViewSet):
    lookup_field = 'uuid'
    queryset = SolicitacaoKitLancheAvulsa.objects.all()
    serializer_class = SolicitacaoKitLancheAvulsaSerializer


class SolicitacaoKitLancheUnificadaViewSet(ModelViewSet):
    lookup_field = 'uuid'
    queryset = SolicitacaoKitLancheUnificada.objects.all()
    serializer_class = SolicitacaoKitLancheUnificadaSerializer
