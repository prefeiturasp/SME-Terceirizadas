# Generated by Django 2.0.13 on 2019-08-20 14:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('kit_lanche', '0008_auto_20190820_1111'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='status',
            field=django_xworkflows.models.StateField(max_length=23, workflow=django_xworkflows.models._SerializedWorkflow(initial_state='RASCUNHO', name='PedidoAPartirDaDiretoriaRegionalWorkflow', states=['RASCUNHO', 'CODAE_A_VALIDAR', 'DRE_PEDE_ESCOLA_REVISAR', 'CODAE_CANCELOU_PEDIDO', 'CODAE_APROVADO', 'CANCELAMENTO_AUTOMATICO'])),
        ),
    ]
