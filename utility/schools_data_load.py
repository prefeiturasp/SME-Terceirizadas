#
# schools_data_load.py
#   Loads school's info from a csv file
#

import environ
import pandas as pd

from sme_pratoaberto_terceirizadas.user_profiles.models import CityLocation, Address, SubTownHall, SchoolUnitType,
ManagementType, SchoolProfile
